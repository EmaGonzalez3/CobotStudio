...
class myCobot320(DHRobotGT):
    def __init__(self,*args, metros=False, rotar_base=False, **kwargs):
        ...
        eje2 = rtb.RevoluteDH(alpha=0,a=136.96*esc,d=0,offset=-np.pi/2,qlim=[-135*np.pi/180,135*np.pi/180])
        eje3 = rtb.RevoluteDH(alpha=0,a=119.5*esc,d=0,offset=0,qlim=[-150*np.pi/180,150*np.pi/180]) 
