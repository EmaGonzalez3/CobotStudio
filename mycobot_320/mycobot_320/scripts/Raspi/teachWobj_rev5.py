    ...
    for idx, pose in enumerate(poses_list, 1):
        ...
        while True:
            ...
            if choice == '1':
                ...
                cob.MoveJAngles(np.zeros(6), 30) # Mover a Home
...
# sendWobj(workobjects[wobj_name], pinza_palp, [1, -1, -1])
