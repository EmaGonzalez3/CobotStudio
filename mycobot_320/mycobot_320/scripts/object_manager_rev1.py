...
class ObjectManager(Node):
    def __init__(self, base_frame='base', tool_frame='link6', freq=5.0):
        ...
        self.attach_distance_threshold = 1000
    ...
    def _handle_auto_attach(self, msg: JointState):
        try:
            ...
            if self.prev_gripper_state is not None:
                ...
                if current_gripper_state < self.prev_gripper_state - 0.01:
                ...
                # Detectar APERTURA: el valor del joint aumenta
                elif current_gripper_state > self.prev_gripper_state + 0.01:
                    ...
                    for obj in self.objects.values():
                        if obj.attached:
                            ...
                            break # Asumimos que solo se puede tener un objeto a la vez

            self.prev_gripper_state = current_gripper_state

        except (ValueError, IndexError):
            # El joint de la pinza no está en el mensaje, no hacemos nada
            pass
