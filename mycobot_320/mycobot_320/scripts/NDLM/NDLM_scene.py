...
def setup_scene(robot_manager: SimManager):
        ...
        pose_init=(235.0e-3 - 12e-3, -171.0e-3 + 70e-3, - brida_base + 20e-3),
        ...
        rot_euler=(np.pi/2, 0, np.pi/2 -np.pi/7.5 - np.pi/2))

        robot_manager.node_obj.add_object(name="llavero1",
        pose_init=(247.0e-3 - 18e-3, -165.721e-3 + 52e-3, - brida_base + 40e-3),
        size=(1.0e-3, 1.0e-3, 1.0e-3),  # escala en metros
        ...
        pose_init=(278.0e-3 - 12e-3, -62.0e-3 + 70e-3, - brida_base + 20e-3),
        size=(1.0e-3, 1.0e-3, 1.0e-3),  # escala en metros
        color=(0.0, 1.0, 0.0, 0.5),
        shape=MESH,
        movable=False,
        ...
        pose_init=(290.0e-3 - 18e-3, -56.721e-3 + 52e-3, - brida_base + 40e-3),
        size=(1.0e-3, 1.0e-3, 1.0e-3),  # escala en metros
        ...
        pose_init=(188.0e-3 - 12e-3, -266.0e-3 + 70e-3, - brida_base + 20e-3),
        size=(1.0e-3, 1.0e-3, 1.0e-3),  # escala en metros
        color=(0.0, 1.0, 0.0, 0.5),
        shape=MESH,
        movable=False,
        ...
        pose_init=(200.0e-3 - 18e-3, -260.721e-3 + 52e-3, - brida_base + 40e-3),
        size=(1.0e-3, 1.0e-3, 1.0e-3),  # escala en metros
