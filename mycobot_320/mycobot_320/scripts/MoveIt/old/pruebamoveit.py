...
def main():
    rclpy.init()
    node = rclpy.create_node("simple_pose_goal")

    node.declare_parameter("position", [0.1, 0.2, 0.25])
    ...
    joint_names2 = ['joint2_to_joint1', 'joint3_to_joint2', 'joint4_to_joint3', 'joint5_to_joint4', 'joint6_to_joint5', 'joint6output_to_joint6','gripper_controller']
    moveit2 = MoveIt2(
        node=node,
